...
export default ({store}) => {
    ...
    /* 
    <path className="around" stroke-dasharray="100, 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"></path>
                    <path className="percent" stroke-dasharray="70, 100" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831"></path>
            ...
            <div id="cercle-container" >
                <div id='cercle'>
                    <svg className="circle-svg">
                        ...
                        <text x="50%" y="50%" dominant-baseline="center" text-anchor="middle" font-size="45" stroke="white" strokeWidth="4" >25°C</text>
                    </svg>
                </div>
            </div>
        </div>
