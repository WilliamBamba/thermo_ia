...
function jeFaisUnTest(val) {
    ...
    if(val >= 10) {
        ...
        chunks.push(<path d="M253.9230 70 a120 120 0 0 1 0 120" fill="none" stroke="url(#linearColors2)" stroke-width="10" />)
    }


    if( val >= 20) {
        console.log('TEMP EN DESSUS DE 8 ET EN DESSOUS DE 16');
        chunks.push(<path d="M253.9230 190 a120 120 0 0 1 -103.9230 60" fill="none" stroke="url(#linearColors3)" stroke-width="10" />)
    }

    if(val >= 30) {
        console.log('TEMP EN DESSUS DE 16 ET EN DESSOUS DE 24');
        chunks.push(<path d="M150 250 a120 120 0 0 1 -103.9230 -60" fill="none" stroke="url(#linearColors4)" stroke-width="10" />)
    }

    if(val >= 40) {
        console.log('TEMP EN DESSUS DE 24 ET EN DESSOUS DE 32');
        chunks.push(<path d="M46.077 190 a120 120 0 0 1 0 -120" fill="none" stroke="url(#linearColors5)" stroke-width="10" />)
    }

    if( val >= 50) {
        console.log('TEMP EN DESSUS DE 32');
        chunks.push(<path d="M46.077 70 a120 120 0 0 1 103.9230 -60" fill="none" stroke="url(#linearColors6)" stroke-width="10" />)
    }
...
export default ({ store }) => {
    ...
    return (
        <svg className="circle-svg">
            ...
            <path d="M150 10 a120 120 0 0 1 103.9230 60" fill="none" stroke="url(#linearColors1)" stroke-width="10" />
